document.addEventListener('DOMContentLoaded', () => {
    ...
    const productos = [
        ...
        },
        {
            ...
            imagen: '../../Recursos/img/cafeteria/ico2.gif'
        },
        {
            nombre: 'Cappuccino',
            precio: 3.5,
            descripcion: 'Café con leche vaporizada y espuma.',
            imagen: '../../Recursos/img/cafeteria/ico3.gif'
        },
        {
            nombre: 'Muffin de Chocolate',
            precio: 2.0,
            descripcion: 'Delicioso muffin de chocolate.',
            imagen: '../../Recursos/img/cafeteria/ico4.gif'
        },
        {
            nombre: 'Croissant',
            precio: 1.5,
            descripcion: 'Croissant recién horneado.',
            imagen: '../../Recursos/img/cafeteria/ico5.gif'
        }
    ];
