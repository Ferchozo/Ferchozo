    ...
    const productos = [
        {
            ...
            imagen:'../../Recursos/img/cafeteria/cafe.gif'
        },
        {
            nombre: 'Latte',
            precio: 3.0,
            descripcion: 'Café con leche espumada.',
            imagen: '../../Recursos/img/cafeteria/latte.gif'
        },
        {
            nombre: 'Cappuccino',
            precio: 3.5,
            descripcion: 'Café con leche vaporizada y espuma.',
            imagen: '../../Recursos/img/cafeteria/cafeta.gif'
        },
        {
            nombre: 'Muffin de Chocolate',
            precio: 2.0,
            descripcion: 'Delicioso muffin de chocolate.',
            imagen: '../../Recursos/img/cafeteria/pastel.gif'
        },
        {
            nombre: 'Croissant',
            precio: 1.5,
            descripcion: 'Croissant recién horneado.',
            imagen: '../../Recursos/img/cafeteria/cuerno.gif'
        }
    ];
